...
def tk_bt(title):
    global tk_button
    tk_button = Button(taskbar,text=title,command= minv,bd=0,highlightthickness=0,activebackground='red',activeforeground='red',bg='white')
...
def new_window(win,ttitle,wd,hg):
    ...
    bar.bind("<ButtonPress-1>", start_drag,window.lift)
...
def create_taskbar():
    ...
    botao = Button(taskbar, text="Menu Iniciar", relief=RAISED,bd=0,highlightthickness=0,bg='white',height=1)
